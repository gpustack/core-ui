...
const AudioPlayer: React.FC<AudioPlayerProps> = forwardRef((props, ref) => {
  ...
  return (
    <div
      className={playerCss['player-wrap']}
      style={{ width: props.width || '100%' }}
    >
      <div className={playerCss['player-ui']}>
        <div className={playerCss['play-content']}>
          <div className={playerCss['progress-bar']}>
            ...
            <div className={playerCss['controls']}>
              <div className="flex-center">
                ...
                <span className={playerCss['play-btn']}>
                  <Button
                    size="middle"
                    type="text"
                    onClick={handlePlay}
